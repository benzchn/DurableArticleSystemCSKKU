...
<head>
    ...
    <link rel="stylesheet" media="all" type="text/css" href="custom/js/jquery-ui.css" />
    <link rel="stylesheet" media="all" type="text/css" href="jquery-ui-timepicker-addon.css" />

    <script type="text/javascript" src="custom/js/jquery-1.10.2.min.js"></script>
    <script type="text/javascript" src="custom/js/jquery-ui.min.js"></script>

    <script type="text/javascript" src="jquery-ui-timepicker-addon.js"></script>
    <script type="text/javascript" src="custom/js/jquery-ui-sliderAccess.js"></script>
